use crate::{
    ...
    domain::{
        ...
        workflow::{
            ...
            LiveVideoSession, LiveVideoSessionAccess, PropertyAgentRequest, RequestThreadView,
            SiteVisitView, UpdateLiveVideoSessionInput, UpdateSiteVisitInput,
        },
    },
...
impl WorkflowUseCases {
    ...
    pub async fn add_thread_message(
        ...
        self.service
            .add_thread_message(actor, response_id, input)
            .await
    }
    ...
    pub async fn create_live_video_session(
        ...
        self.service
            .create_live_video_session(actor, response_id, input)
            .await
    }
    ...
    pub async fn update_live_video_session(
        ...
        self.service
            .update_live_video_session(actor, session_id, input)
            .await
    }
    ...
    pub async fn get_live_video_session_access(
        ...
        self.service
            .get_live_video_session_access(actor, session_id)
            .await
    }
    ...
    pub async fn create_site_visit(
        ...
        self.service
            .create_site_visit(actor, response_id, input)
            .await
    }
    ...
    pub async fn update_site_visit(
        ...
        self.service
            .update_site_visit(actor, site_visit_id, input)
            .await
    }
    ...
    pub async fn certify_site_visit(
        ...
        self.service
            .certify_site_visit(actor, site_visit_id, input)
            .await
    }
    ...
    pub async fn create_property_agent_request(
        ...
        self.service
            .create_property_agent_request(actor, property_id, input)
            .await
    }
    ...
    pub async fn assign_property_agent(
        ...
        self.service
            .assign_property_agent(actor, property_id, input)
            .await
    }
